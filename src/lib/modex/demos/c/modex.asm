...
SET_VGA_MODEX   PROC    FAR
    ...
    SHR     AX, 1               ; # of Bytes:Line = XSize/4
    SHR     AX, 1               ; # of Bytes:Line = XSize/4
...
SET_POINT   PROC    FAR
    ...
    SHR     BX, 1               ; X offset (Bytes) = Xpos/4
    SHR     BX, 1               ; X offset (Bytes) = Xpos/4
...
READ_POINT      PROC    FAR
    ...
    mov ah,0                  ; Clear Return Value Hi byte
...
@DL_HORZ:
    ...
    SHR     AX, 1               ; Get X1 Byte # (=X1/4)
    SHR     CX, 1               ; Get X2 Byte # (=X2/4)
    SHR     AX, 1               ; Get X1 Byte # (=X1/4)
    SHR     CX, 1               ; Get X2 Byte # (=X2/4)
...
@DL_DeltaYOK:
    ...
    SHR     AX, 1               ; /4 = Byte Offset into Line
    SHR     AX, 1               ; /4 = Byte Offset into Line
...
@DL_ShallowLeft:
    mov ax,0                  ; zero low word of Delta_Y * 10000h
...
@LDR_Load:
    ...
    mov ax,0, BX                  ; Clear for byte loads
...
GPRINTC     PROC    FAR
    ...
    SHR     AX, 1               ; Bytes into Line = Xpos/4
    SHR     AX, 1               ; Bytes into Line = Xpos/4
...
DRAW_BITMAP PROC    FAR
    ...
    SHR     BX, 1               ; Xpos/4 = Offset Into Line
    SHR     BX, 1               ; Xpos/4 = Offset Into Line
...
COPY_BITMAP PROC    FAR
    ...
    SHR     AX, 1               ; Get X2 Band (X2 / 4)
    SHR     DX, 1               ; Get X1 Band (X1 / 4)
    SHR     AX, 1               ; Get X2 Band (X2 / 4)
    SHR     DX, 1               ; Get X1 Band (X1 / 4)
